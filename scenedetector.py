...
SCENE_DETECT_USE_EARLY_DROP = 'true'
SVM_NAME = 'SceneDetectionSVM.sav'
...
def calculate_score(sim_structural, sim_ocr, sim_structural_no_face, svm_name):
    """
    ...
    svm_name (string): Filename of the trained SVM model
...
def find_scenes(video_path):
    ...
    try:
        ...
        predicted_labels = calculate_score(
            sim_structural, sim_ocr, sim_structural_no_face, SVM_NAME)
        ...
        print(">>> finished running find_scenes")
